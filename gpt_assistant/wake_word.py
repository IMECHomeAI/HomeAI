...
#temp_dir = tempfile.TemporaryDirectory(dir=r'D:\gpt-assistant\temp_wav')
temp_dir_path = r'D:\gpt-assistant'

def listen_for_wake_word(callback):
    with tempfile.NamedTemporaryFile(delete=False, suffix=".wav", dir=temp_dir_path) as wav_file:
        recorder = PvRecorder(
